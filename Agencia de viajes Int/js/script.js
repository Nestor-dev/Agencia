    ...
    function validar() {
        ...
        const input = document.forms['form1']['nombre'];
        ...
        const pattern = new RegExp('^[A-Z]+$', 'i'); ///^[a-zA-ZÑñÁáÉéÍíÓóÚúÜü\s]+$/
      ...
      function verificar() {
        ...
        if (!valido) {
          alert('El nombre es invalido, ingresa un nombre correctamente.');
        }
      }
